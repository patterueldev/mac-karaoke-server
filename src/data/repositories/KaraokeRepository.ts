...
export default interface KaraokeRepository {
  getSongRecords(filter?: string, offset?: number, limit?: number): Promise<SongRecord[]>;
  ...
  removeReservedSong(reservationId: string): Promise<void>;
  stopCurrentSong(): Promise<void>;
}